...
namespace SPI_Data_Comp_Tool
{
    public partial class SPI_Analysis_View : Form
    {
        ...
        private DataView dv_unique_source, dv_unique_target, dv_source, dv_target, dv_1, dv_2;
        ...
        private bool boolStatus, boolFormLoad;
        ...
        private void btn_SaveInExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                #region  using GEMBOX code assembly

                //SpreadsheetInfo.SetLicense("FREE-LIMITED-KEY");

                //var workbook = new ExcelFile();
                //var worksheet = workbook.Worksheets.Add("DT to sheet");

                //worksheet.InsertDataTable(dt_source_arranged, new InsertDataTableOptions
                //{
                //    ColumnHeaders = true,
                //    StartRow = 0,
                //    StartColumn = 0
                ...
                //worksheet.DefaultColumnWidth = worksheet.DefaultColumnWidth + 10;

                //workbook.Save(excelFileNameSaved);

                #endregion

                

                #region synfusion code assembly
                ...
                //    worksheet.ImportDataTable(dt_source_arranged, true, 1, 1);
                //    worksheet.ImportDataTable(dt_target_arranged, true, 1, 6);
                //    worksheet.ImportDataTable(dt_remarks, true, 1, 11);

                //    worksheet.UsedRange.AutofitColumns();

                //    workbook.SaveAs(excelFileNameSaved);
                //}
                #endregion

                //Process.Start(excelFileNameSaved);
