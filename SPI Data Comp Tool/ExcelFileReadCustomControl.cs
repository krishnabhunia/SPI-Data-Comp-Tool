...
namespace SPI_Data_Comp_Tool
{
    public partial class ExcelFileReadCustomControl : UserControl
    {
        ...
        private void btn_Excel_Click(object sender, EventArgs e)
        {
            ...
            {
                ds = LoadDataExcel();
                GetExcelData.DynamicInvoke(ds,openFileDialogData.FileName_Only);
            }
            catch (Exception ex)
            {
        ...
        private DataSet LoadDataExcel()
        {
            try
            {
                ...
                lbl_ExcelFileName.Text = openFileDialogData.fileNameWithPath;
                if(boolFileSelected)
                {
        ...
        private OpenFileDialogData openFileDialog(string str_title = "Browse Excel Files")
        {
            ...
            {
                openFileDialogData.fileNameWithPath = openFileDialog1.FileName.ToString();
            ...
            else
            {
                ...
                openFileDialogData.fileNameWithPath = "File Not Selected";
                boolFileSelected = false;
            }
